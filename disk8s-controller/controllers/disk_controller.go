...
//+kubebuilder:rbac:groups=disk8s.disk8s.plockc.org,resources=disks,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=disk8s.disk8s.plockc.org,resources=disks/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=disk8s.disk8s.plockc.org,resources=disks/finalizers,verbs=update
